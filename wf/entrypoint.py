...
def nextflow_runtime(pvc_name: str, input_fastas: LatchDir, outdir: typing_extensions.Annotated[LatchDir, FlyteAnnotation({'output': True})], peptides_db: LatchFile, models_list: LatchFile, models_dir: LatchDir) -> None:
    ...
    latch_log_dir = urljoins("latch:///your_log_dir/nf_peptide_bioactivity_predictor", exec_name)
    ...
    cmd = [
        ...
        "latch.config",
        "-resume",
                *get_flag('input_fastas', input_fastas),
    ...
    try:
        env = {
            **os.environ,
            ...
            "NXF_OPTS": "-Xms3840M -Xmx15360M -XX:ActiveProcessorCount=16",
